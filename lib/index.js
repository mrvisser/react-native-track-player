...
function reset({deactivate = false} = {}) {
    return TrackPlayer.reset({deactivate});
}
function pause({deactivate = false} = {}) {
    return TrackPlayer.pause({deactivate});
}
function stop({deactivate = false} = {}) {
    return TrackPlayer.stop({deactivate});
}
...
module.exports.duckOthers = TrackPlayer.duckOthers;
module.exports.unduckOthers = TrackPlayer.unduckOthers;
